...
public:
  ...
  void rangeInTolerance(TRange &range, BField const &bfield,
                        double tol) const {}; // infinity for striaght line

  // local momentum direction basis
  Vec3 direction(double time,
                 LocalBasis::LocDir mdir = LocalBasis::momdir) const;
